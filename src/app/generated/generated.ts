...
export type AdditionalDataStats = {
...
export type EventMultiGuestSettings = {
  __typename?: 'EventMultiGuestSettings';
  additionalGuestPrice: Scalars['Float']['output'];
  enabled: Scalars['Boolean']['output'];
  maxPerRegistration?: Maybe<Scalars['Int']['output']>;
};
...
export type EventRegistration = {
  ...
  event: TumiEvent;
  eventId: Scalars['ID']['output'];
  guestCheckIns: Scalars['Int']['output'];
  guestCount: Scalars['Int']['output'];
  guestUnitPrice?: Maybe<Scalars['Decimal']['output']>;
  id: Scalars['ID']['output'];
  manualCheckin: Scalars['Boolean']['output'];
  rating?: Maybe<Scalars['Int']['output']>;
  remainingEntries: Scalars['Int']['output'];
  status: RegistrationStatus;
  submissions: Array<EventSubmission>;
  totalPartySize: Scalars['Int']['output'];
  transactions: Array<Transaction>;
  type: RegistrationType;
  usageLog: Array<RegistrationUsageEntry>;
  user: User;
...
export type HistoricalData = {
  ...
  eventsStarted: Scalars['Int']['output'];
  usersCheckedIn: Scalars['Int']['output'];
...
export type Mutation = {
  ...
  configureEventMultiGuests: TumiEvent;
  ...
  useRegistrationEntry: EventRegistration;
};
...
export type MutationConfigureEventMultiGuestsArgs = {
  eventId: Scalars['ID']['input'];
  input: EventMultiGuestSettingsInput;
};
...
export type MutationUpdateEventOrganizerArgs = {
  id: Scalars['ID']['input'];
  input: NewOrganizerInput;
};


export type MutationUpdateEventTemplateCategoryArgs = {
  categoryId: Scalars['ID']['input'];
  input: CreateEventTemplateCategoryInput;
};
...
export type MutationUseRegistrationEntryArgs = {
...
export type PieChartSeries = {
  ...
  angleKey: Scalars['String']['output'];
  legendItemKey: Scalars['String']['output'];
  type: Scalars['String']['output'];
};

export type PieChartTitle = {
  __typename?: 'PieChartTitle';
  text: Scalars['String']['output'];
};
...
export type Query = {
  ...
  transactions: Array<Transaction>;
  user: User;
  userDataStatistics: Array<AdditionalDataStats>;
...
export type QueryGridUsersCountArgs = {
  eventId?: InputMaybe<Scalars['ID']['input']>;
  filterModel: Scalars['JSONObject']['input'];
};


export type QueryHistoricalStatisticsArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
...
export type QueryUserDataStatisticsArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
};
...
export type RangeStatsCheckInsArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
};


export type RangeStatsEventsStartedArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
};


export type RangeStatsRegisteredParticipantsArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
};


export type RangeStatsRegisteredUsersArgs = {
  end: Scalars['DateTime']['input'];
  start: Scalars['DateTime']['input'];
};
...
export type RegistrationUsageEntry = {
...
export type TumiEvent = {
  ...
  deferredPayment: Scalars['Boolean']['output'];
  description: Scalars['String']['output'];
  ...
  isVirtual: Scalars['Boolean']['output'];
  location: Scalars['String']['output'];
  multiGuestSettings?: Maybe<EventMultiGuestSettings>;
  ...
  title: Scalars['String']['output'];
  totalGuestsCount: Scalars['Int']['output'];
  /** Total people registered including guests */
  totalRegisteredCount: Scalars['Int']['output'];
...
export type UpdateCoreEventInput = {
  ...
  deferredPayment?: InputMaybe<Scalars['Boolean']['input']>;
  ...
  multiGuestSettings?: InputMaybe<EventMultiGuestSettingsInput>;
...
export type GetCurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, profileComplete: boolean, firstName: string, lastName: string, email: string, picture: string, birthdate?: string | null, status: MembershipStatus, role: Role } | null };
...
export type GetInitialUserGridDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetInitialUserGridDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, createdAt: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, label: string, options: Array<string> }> } } };

export type GetUsersForUserGridQueryVariables = Exact<{
  startRow: Scalars['Int']['input'];
  endRow: Scalars['Int']['input'];
...
export type GetTenantCurrencyCodeQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, currency: Currency } };

export type GetAppStartupInfoQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAppStartupInfoQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, currency: Currency, homePageStrategy: HomePageStrategy, homePageLink?: string | null, contractEnd: string, hardContractEnd: boolean, settings: { __typename?: 'TenantSettings', showPWAInstall: boolean, timezone: string, brandIconUrl?: string | null, userDataCollection: Array<{ __typename?: 'DynamicFormField', label: string, options: Array<string>, type: string }>, banners: Array<{ __typename?: 'BannerConfig', title: string, body: string, color: string, link: string, displayToMembershipStatus: Array<MembershipStatus> }> } } };
...
export type CreateEventTemplateMutation = { __typename?: 'Mutation', createEventTemplate: { __typename?: 'EventTemplate', id: string, createdAt: string } };
...
export type RegisterForEventMutation = { __typename?: 'Mutation', registerForEvent: { __typename?: 'TumiEvent', id: string, organizerRegistrationPossible: boolean, participantRegistrationPossible: any, organizersRegistered: number, participantRegistrationCount: number, totalRegisteredCount: number, couldBeOrganizer: boolean, userIsRegistered: boolean, activeRegistration?: { __typename?: 'EventRegistration', id: string, type: RegistrationType, status: RegistrationStatus, cancellationReason?: string | null, guestCount: number, guestUnitPrice?: any | null, totalPartySize: number, remainingEntries: number, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, createdAt: string, amount: any, status: string, checkoutUrl?: string | null, paymentIntent?: string | null } | null }> } | null, organizers: Array<{ __typename?: 'User', fullName: string }> } };
...
export type LoadRegistrationForMoveQuery = { __typename?: 'Query', registration?: { __typename?: 'EventRegistration', id: string, eventId: string, deletingCode?: { __typename?: 'EventRegistrationCode', id: string, isPublic: boolean } | null } | null };
...
export type GetCostItemQuery = { __typename?: 'Query', costItem: { __typename?: 'CostItem', id: string, name: string, amount: any, submittedAmount: any, event: { __typename?: 'TumiEvent', id: string, title: string }, receipts: Array<{ __typename?: 'Receipt', id: string, createdAt: string, amount: any, url: string, type?: string | null, originalUrl: string, user: { __typename?: 'User', id: string, fullName: string } }> } };
...
export type GetRegistrationQuery = { __typename?: 'Query', registration?: { __typename?: 'EventRegistration', id: string, status: RegistrationStatus, type: RegistrationType, didAttend: boolean, checkInTime?: string | null, guestCount: number, guestUnitPrice?: any | null, guestCheckIns: number, totalPartySize: number, remainingEntries: number, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string } | null }>, usageLog: Array<{ __typename?: 'RegistrationUsageEntry', timestamp: string, actorId?: string | null, manual: boolean, note?: string | null }>, event: { __typename?: 'TumiEvent', id: string, title: string, icon: string }, user: { __typename?: 'User', id: string, fullName: string, picture: string, esnCardNumber?: string | null, esnCardValidUntil?: string | null } } | null };
...
export type CheckInUserMutation = { __typename?: 'Mutation', checkInUser: { __typename?: 'EventRegistration', id: string, checkInTime?: string | null, didAttend: boolean } };
...
export type UseRegistrationEntryMutation = { __typename?: 'Mutation', useRegistrationEntry: { __typename?: 'EventRegistration', id: string, guestCount: number, guestCheckIns: number, checkInTime?: string | null, totalPartySize: number, remainingEntries: number, usageLog: Array<{ __typename?: 'RegistrationUsageEntry', timestamp: string, actorId?: string | null, manual: boolean, note?: string | null }> } };
...
export type LoadEventDisplayDataQuery = { __typename?: 'Query', event: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, description: string } };

export type GetEventListForShellQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEventListForShellQuery = { __typename?: 'Query', events: Array<{ __typename?: 'TumiEvent', id: string, icon: string, title: string, start: string, end: string, publicationState: PublicationState }> };
...
export type LoadEventQuery = { __typename?: 'Query', event: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, registrationStart: string, organizerRegistrationStart: string, enablePhotoSharing: boolean, publicationState: PublicationState, description: string, organizerText: string, organizerLimit: number, participantText: string, registrationMode: RegistrationMode, registrationLink?: string | null, freeParticipantSpots: string, excludeFromRatings: boolean, deferredPayment: boolean, ratingPending: boolean, prices?: any | null, location: string, coordinates?: any | null, googlePlaceUrl?: string | null, isVirtual: boolean, onlineMeetingUrl?: string | null, organizerSignup: Array<string>, participantSignup: Array<string>, organizerRegistrationPossible: boolean, participantRegistrationPossible: any, userIsRegistered: boolean, userIsOrganizer: boolean, userIsCreator: boolean, participantLimit: number, totalGuestsCount: number, totalRegisteredCount: number, participantRegistrationCount: number, couldBeOrganizer: boolean, couldBeParticipant: boolean, participantRating?: number | null, participantRatingCount: number, deRegistrationSettings: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number }, participants: { __typename?: 'ParticipantDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean, movePossible: boolean, minimumDaysForMove: number, refundFeesOnMove: boolean } }, createdBy: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, submissionItems: Array<{ __typename?: 'EventSubmissionItem', id: string, name: string, submissionTime: SubmissionTime, instruction: string, required: boolean, type: string, data?: any | null, ownSubmissions: Array<{ __typename?: 'EventSubmission', id: string, data: any }> }>, organizer: { __typename?: 'EventOrganizer', id: string, link?: string | null, text: string }, activeRegistration?: { __typename?: 'EventRegistration', id: string, didAttend: boolean, status: RegistrationStatus, guestCount: number, guestUnitPrice?: any | null, totalPartySize: number, remainingEntries: number, userComment?: string | null, rating?: number | null, anonymousRating: boolean, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, createdAt: string, amount: any, status: string, paymentIntent?: string | null, checkoutUrl?: string | null } | null }>, user: { __typename?: 'User', id: string, fullName: string } } | null, multiGuestSettings?: { __typename?: 'EventMultiGuestSettings', enabled: boolean, additionalGuestPrice: number, maxPerRegistration?: number | null } | null, ratings: Array<{ __typename?: 'EventRegistration', userComment?: string | null, rating?: number | null, type: RegistrationType, anonymousRating: boolean, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null } }>, organizers: Array<{ __typename?: 'User', id: string, fullName: string, picture: string, acceptPhoneUsage: boolean, phoneNumberOnWhatsapp: boolean, telegramUsername?: string | null, phone?: string | null, communicationEmail?: string | null, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }> } };
...
export type LoadUserForEventQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, esnCardValidUntil?: string | null } | null };
...
export type UpdateCoreEventMutation = { __typename?: 'Mutation', updateEventCoreInfo: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, registrationStart: string, organizerRegistrationStart: string, prices?: any | null, registrationMode: RegistrationMode, registrationLink?: string | null, eventOrganizerId: string, organizerSignup: Array<string>, participantSignup: Array<string>, participantLimit: number, organizerLimit: number, excludeFromRatings: boolean, deferredPayment: boolean, excludeFromStatistics: boolean, enablePhotoSharing: boolean, multiGuestSettings?: { __typename?: 'EventMultiGuestSettings', enabled: boolean, additionalGuestPrice: number, maxPerRegistration?: number | null } | null } };
...
export type AddSubmissionToEventMutation = { __typename?: 'Mutation', createSubmissionItem: { __typename?: 'EventSubmissionItem', id: string, createdAt: string, required: boolean, submissionTime: SubmissionTime, type: string, instruction: string, name: string, event: { __typename?: 'TumiEvent', id: string, submissionItems: Array<{ __typename?: 'EventSubmissionItem', id: string }> } } };
...
export type LoadEventForManagementQuery = { __typename?: 'Query', event: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, amountCollected: any, netAmountCollected: any, feesPaid: any, refundFeesPaid: any, plannedSpend: any, submittedSpend: any, deferredPayment: boolean, participantLimit: number, participantRegistrationCount: number, totalGuestsCount: number, totalRegisteredCount: number, participantsAttended: number, registrationMode: RegistrationMode, multiGuestSettings?: { __typename?: 'EventMultiGuestSettings', enabled: boolean, additionalGuestPrice: number, maxPerRegistration?: number | null } | null, costItems: Array<{ __typename?: 'CostItem', id: string, name: string, submittedAmount: any, amount: any }>, eventTemplate: { __typename?: 'EventTemplate', id: string, title: string }, eventRegistrationCodes: Array<{ __typename?: 'EventRegistrationCode', id: string, createdAt: string, isPublic: boolean, status: RegistrationStatus, registrationToRemoveId?: string | null, registrationCreatedId?: string | null }>, organizerRegistrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, status: RegistrationStatus, user: { __typename?: 'User', id: string, fullName: string, picture: string, email: string, additionalData: any, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null } }>, submissionItems: Array<{ __typename?: 'EventSubmissionItem', id: string, name: string }>, participantRegistrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, status: RegistrationStatus, cancellationReason?: string | null, balance: any, guestCount: number, guestUnitPrice?: any | null, guestCheckIns: number, totalPartySize: number, remainingEntries: number, checkInTime?: string | null, didAttend: boolean, usageLog: Array<{ __typename?: 'RegistrationUsageEntry', timestamp: string, actorId?: string | null, manual: boolean, note?: string | null }>, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string } | null }>, submissions: Array<{ __typename?: 'EventSubmission', id: string, data: any, submissionItem: { __typename?: 'EventSubmissionItem', id: string, name: string } }>, user: { __typename?: 'User', id: string, fullName: string, firstName: string, lastName: string, picture: string, phone?: string | null, email: string, additionalData: any, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null } }> } };

export type AdmitUserMutationVariables = Exact<{
  registrationId: Scalars['ID']['input'];
}>;


export type AdmitUserMutation = { __typename?: 'Mutation', approvePayment: { __typename?: 'TumiEvent', id: string, participantRegistrations: Array<{ __typename?: 'EventRegistration', id: string, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string } | null }> }> } };
...
export type AddCostItemToEventMutation = { __typename?: 'Mutation', addCostItemToEvent: { __typename?: 'TumiEvent', id: string, costItems: Array<{ __typename?: 'CostItem', id: string, name: string, amount: any, calculationInfo: string }> } };

export type LoadPublicRegistrationCodesQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadPublicRegistrationCodesQuery = { __typename?: 'Query', eventRegistrationCodes: Array<{ __typename?: 'EventRegistrationCode', id: string, targetEvent: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string } }> };
...
export type GetInitialGlobalStatisticsDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, createdAt: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, label: string, options: Array<string> }> } }, allTimeStatistics: { __typename?: 'AllTimeStats', globalUsers: number, events: number, registeredParticipants: number, checkIns: number }, sinceTimeStatistics: { __typename?: 'SinceTimeStatistics', globalUsers: number, events: number, registeredParticipants: number, checkIns: number } };
...
export type GetHomePageDataQuery = { __typename?: 'Query', events: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string }>, currentUser?: { __typename?: 'User', id: string } | null };
...
export type LoadCompleteProfileDataQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadCompleteProfileDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, name: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, options: Array<string>, label: string }> } }, currentUser?: { __typename?: 'User', id: string, firstName: string, lastName: string, email: string, phone?: string | null, phoneNumberOnWhatsapp: boolean, telegramUsername?: string | null, acceptPhoneUsage: boolean, communicationEmail?: string | null, birthdate?: string | null, lastPrivacyAcceptance?: string | null, additionalData: any } | null };
...
export type CompleteProfileMutationMutation = { __typename?: 'Mutation', completeProfile: { __typename?: 'User', id: string, firstName: string, lastName: string, email: string, phone?: string | null, phoneNumberOnWhatsapp: boolean, telegramUsername?: string | null, acceptPhoneUsage: boolean, birthdate?: string | null, additionalData: any } };
...
export type AddEsnCardMutation = { __typename?: 'Mutation', addESNCard: { __typename?: 'User', id: string, esnCardNumber?: string | null, esnCardValidUntil?: string | null } };
...
export type GetPhotoJourneyQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', eventRegistrations: Array<{ __typename?: 'EventRegistration', id: string, status: RegistrationStatus, event: { __typename?: 'TumiEvent', id: string, title: string, icon: string, location: string, start: string, photoShares: Array<{ __typename?: 'PhotoShare', id: string, type: string, src: string, original: string, originalBlob: string, container: string, cols: number, rows: number }> } }> } | null };

export type UserProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type UserProfileQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, fullName: string, picture: string, emailVerified: boolean, email: string, communicationEmail?: string | null, iban?: string | null, paypal?: string | null, phone?: string | null, phoneNumberOnWhatsapp: boolean, telegramUsername?: string | null, acceptPhoneUsage: boolean, birthdate?: string | null, firstName: string, lastName: string, calendarToken: string, esnCardNumber?: string | null, esnCardValidUntil?: string | null, position?: string | null, additionalData: any, status: MembershipStatus, organizedEventsCount: number, createdEventsCount: number } | null, currentTenant: { __typename?: 'Tenant', settings: { __typename?: 'TenantSettings', esnCardLink?: string | null } } };

export type UserProfileEventsQueryVariables = Exact<{ [key: string]: never; }>;


export type UserProfileEventsQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, createdEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, ratingPending: boolean, participantRating?: number | null, participantRatingCount: number }>, organizedEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, ratingPending: boolean, userIsOrganizer: boolean, participantRating?: number | null, participantRatingCount: number }>, participatedEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, ratingPending: boolean, userIsOrganizer: boolean, participantRating?: number | null, participantRatingCount: number }> } | null };
...
export type UserProfilePublicQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, firstName: string, fullName: string, picture: string, position?: string | null, organizedEventsCount: number, createdEventsCount: number, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, commonEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string }> };
...
export type GetRegistrationCodeInfoQuery = { __typename?: 'Query', eventRegistrationCode: { __typename?: 'EventRegistrationCode', id: string, status: RegistrationStatus, registrationCreated?: { __typename?: 'EventRegistration', id: string, belongsToCurrentUser: boolean, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, checkoutUrl?: string | null } | null }> } | null, targetEvent: { __typename?: 'TumiEvent', id: string, registrationMode: RegistrationMode, title: string, start: string, prices?: any | null } } };
...
export type UseRegistrationCodeMutation = { __typename?: 'Mutation', useRegistrationCode: { __typename?: 'EventRegistrationCode', id: string, status: RegistrationStatus, registrationCreated?: { __typename?: 'EventRegistration', id: string, belongsToCurrentUser: boolean, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, checkoutSession: string } | null }> } | null, targetEvent: { __typename?: 'TumiEvent', id: string, registrationMode: RegistrationMode, title: string, start: string, prices?: any | null } } };

export type LoadDeRegistrationSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadDeRegistrationSettingsQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, settings: { __typename?: 'TenantSettings', deRegistrationOptions: { __typename?: 'GlobalDeRegistrationConfig', free: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', refundFeesOnDeRegistration: boolean, minimumDaysForDeRegistration: number, deRegistrationPossible: boolean, minimumDaysForMove: number, movePossible: boolean, refundFeesOnMove: boolean } }, paid: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', refundFeesOnDeRegistration: boolean, minimumDaysForDeRegistration: number, deRegistrationPossible: boolean, minimumDaysForMove: number, movePossible: boolean, refundFeesOnMove: boolean } } } } } };
...
export type UpdateDeRegistrationSettingsMutation = { __typename?: 'Mutation', updateTenant: { __typename?: 'Tenant', id: string, settings: { __typename?: 'TenantSettings', deRegistrationOptions: { __typename?: 'GlobalDeRegistrationConfig', free: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', refundFeesOnDeRegistration: boolean, minimumDaysForDeRegistration: number, deRegistrationPossible: boolean, minimumDaysForMove: number, movePossible: boolean, refundFeesOnMove: boolean } }, paid: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', refundFeesOnDeRegistration: boolean, minimumDaysForDeRegistration: number, deRegistrationPossible: boolean, minimumDaysForMove: number, movePossible: boolean, refundFeesOnMove: boolean } } } } } };

export type LoadRegistrationDataSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadRegistrationDataSettingsQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', label: string, options: Array<string>, type: string }> } } };
...
export type UpdateRegistrationDataSettingsMutation = { __typename?: 'Mutation', updateTenant: { __typename?: 'Tenant', id: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', label: string, options: Array<string>, type: string }> } } };
...
export type UpdateSectionSettingsMutation = { __typename?: 'Mutation', updateTenant: { __typename?: 'Tenant', id: string, settings: { __typename?: 'TenantSettings', brandIconUrl?: string | null, esnCardLink?: string | null, timezone: string, showPWAInstall: boolean, sectionHubLinks: Array<{ __typename?: 'ResourceLink', icon: string, label: string, url: string }>, socialLinks: Array<{ __typename?: 'ResourceLink', icon: string, label: string, url: string }>, banners: Array<{ __typename?: 'BannerConfig', displayToMembershipStatus: Array<MembershipStatus>, link: string, color: string, body: string, title: string }> } } };

export type LoadSiteContentSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type LoadSiteContentSettingsQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, aboutPage: string, faqPage?: string | null, tacPage?: string | null, imprintPage: string, privacyPolicyPage: string } };
...
export type UpdateSiteContentSettingsMutation = { __typename?: 'Mutation', updateTenant: { __typename?: 'Tenant', id: string, aboutPage: string, faqPage?: string | null, tacPage?: string | null, imprintPage: string, privacyPolicyPage: string } };

export type UserRolesQueryVariables = Exact<{ [key: string]: never; }>;


export type UserRolesQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, fullName: string, esnCardValidUntil?: string | null, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, role: Role, status: MembershipStatus } | null } | null };
...
export type TenantLoadEventsQuery = { __typename?: 'Query', events: Array<{ __typename?: 'TumiEvent', id: string, title: string, description: string, start: string, end: string, createdAt: string, publicationState: PublicationState, icon: string }> };
...
export type UpdateEventTemplateCategoryMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  input: CreateEventTemplateCategoryInput;
}>;


export type UpdateEventTemplateCategoryMutation = { __typename?: 'Mutation', updateEventTemplateCategory: { __typename?: 'EventTemplateCategory', id: string, name: string, icon: string } };
...
export type GetRegistrationsQuery = { __typename?: 'Query', registrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, type: RegistrationType, balance: any, event: { __typename?: 'TumiEvent', title: string, id: string, icon: string }, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, netAmount?: any | null } | null }> }> };
...
export type GetRegistrationForAdminQuery = { __typename?: 'Query', registration?: { __typename?: 'EventRegistration', id: string, createdAt: string, type: RegistrationType, status: RegistrationStatus, cancellationReason?: string | null, guestCount: number, guestCheckIns: number, totalPartySize: number, remainingEntries: number, event: { __typename?: 'TumiEvent', title: string, id: string, start: string, end: string, icon: string, multiGuestSettings?: { __typename?: 'EventMultiGuestSettings', enabled: boolean, maxPerRegistration?: number | null, additionalGuestPrice: number } | null }, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, usageLog: Array<{ __typename?: 'RegistrationUsageEntry', timestamp: string, actorId?: string | null, manual: boolean, note?: string | null }>, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, netAmount?: any | null, refundedAmount?: any | null, amount: any, feeAmount?: any | null, paymentIntent?: string | null, paymentMethodType?: string | null, events: any } | null }> } | null };
...
export type GetCancelledRegistrationsQuery = { __typename?: 'Query', registrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, cancellationReason?: string | null, event: { __typename?: 'TumiEvent', title: string, id: string }, user: { __typename?: 'User', id: string, fullName: string } }> };
...
export type GetEventRegistrationCodesQuery = { __typename?: 'Query', eventRegistrationCodes: Array<{ __typename?: 'EventRegistrationCode', id: string, createdAt: string, isPublic: boolean, status: RegistrationStatus, targetEvent: { __typename?: 'TumiEvent', id: string, title: string, icon: string }, creator: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, registrationToRemove?: { __typename?: 'EventRegistration', id: string } | null, registrationCreated?: { __typename?: 'EventRegistration', id: string, createdAt: string, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null } } | null }> };
...
export type GetEventRegistrationCodeQuery = { __typename?: 'Query', eventRegistrationCode: { __typename?: 'EventRegistrationCode', id: string, createdAt: string, isPublic: boolean, status: RegistrationStatus, sepaAllowed: boolean, targetEvent: { __typename?: 'TumiEvent', id: string, title: string, start: string, end: string, icon: string }, creator: { __typename?: 'User', id: string, email: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, connectedRegistrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, status: RegistrationStatus, cancellationReason?: string | null, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, paymentMethodType?: string | null, paymentIntent?: string | null, events: any } | null }> }>, registrationToRemove?: { __typename?: 'EventRegistration', id: string, createdAt: string, status: RegistrationStatus, cancellationReason?: string | null, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, paymentMethodType?: string | null, paymentIntent?: string | null, events: any } | null }> } | null, registrationCreated?: { __typename?: 'EventRegistration', id: string, createdAt: string, status: RegistrationStatus, cancellationReason?: string | null, user: { __typename?: 'User', id: string, fullName: string, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, status: MembershipStatus } | null }, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, paymentIntent?: string | null, paymentMethodType?: string | null, events: any } | null }> } | null } };
...
export type UpdateOrganizerMutation = { __typename?: 'Mutation', updateEventOrganizer: { __typename?: 'EventOrganizer', id: string, name: string, text: string, link?: string | null } };

export type GetOrganizersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOrganizersQuery = { __typename?: 'Query', eventOrganizers: Array<{ __typename?: 'EventOrganizer', id: string, name: string, text: string, link?: string | null }> };

export type GetInitialStatisticsDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetInitialStatisticsDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, createdAt: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, label: string, options: Array<string> }> } }, allTimeStatistics: { __typename?: 'AllTimeStats', registeredUsers: number, events: number, registeredParticipants: number, checkIns: number } };

export type GetRangeStatisticsQueryVariables = Exact<{
  startDate: Scalars['DateTime']['input'];
  endDate: Scalars['DateTime']['input'];
  unit: Scalars['String']['input'];
}>;
...
export type GetRangeStatisticsQuery = { __typename?: 'Query', rangeStatistics: { __typename?: 'RangeStats', registeredUsers: number, eventsStarted: number, registeredParticipants: number, checkIns: number }, registrationHistory: Array<{ __typename?: 'HistoricalData', date: string, eventRegistrations: number, usersCheckedIn: number }>, userHistory: Array<{ __typename?: 'HistoricalData', date: string, usersRegistered: number }>, eventHistory: Array<{ __typename?: 'HistoricalData', date: string, eventsCreated: number, eventsStarted: number }>, userDataStatistics: Array<{ __typename?: 'AdditionalDataStats', data: Array<{ __typename?: 'PieChartData', name: string, value: number }>, title: { __typename?: 'PieChartTitle', text: string }, series: Array<{ __typename?: 'PieChartSeries', angleKey: string, legendItemKey: string, type: string }> }> };
...
export type LoadTransactionsQuery = { __typename?: 'Query', transactionCount: number, transactionNetAmount: any, transactions: Array<{ __typename?: 'Transaction', id: string, amount: any, createdAt: string, type: TransactionType, subject: string, status: TransactionStatus, direction: TransactionDirection, eventRegistration?: { __typename?: 'EventRegistration', id: string, event: { __typename?: 'TumiEvent', id: string, title: string } } | null, user?: { __typename?: 'User', id: string, fullName: string } | null }> };

export type GetInitialAdminUsersDataQueryVariables = Exact<{ [key: string]: never; }>;


export type GetInitialAdminUsersDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, createdAt: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, label: string, options: Array<string> }> } } };

export type GetUsersForAdminGridQueryVariables = Exact<{
  startRow: Scalars['Int']['input'];
  endRow: Scalars['Int']['input'];
  sortModel: Array<SortModelInput> | SortModelInput;
  filterModel: Scalars['JSONObject']['input'];
...
export type LoadUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, authId: string, firstName: string, lastName: string, fullName: string, email: string, birthdate?: string | null, esnCardValidUntil?: string | null, esnCardNumber?: string | null, position?: string | null, picture: string, currentTenant?: { __typename?: 'UsersOfTenants', userId: string, tenantId: string, role: Role, status: MembershipStatus } | null, eventRegistrations: Array<{ __typename?: 'EventRegistration', id: string, createdAt: string, checkInTime?: string | null, type: RegistrationType, status: RegistrationStatus, deletingCode?: { __typename?: 'EventRegistrationCode', id: string, createdAt: string } | null, creatingCode?: { __typename?: 'EventRegistrationCode', id: string, createdAt: string } | null, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string, events: any } | null }>, event: { __typename?: 'TumiEvent', id: string, title: string, start: string, end: string, icon: string } }> } };

export type GetTenantForEditQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTenantForEditQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, name: string, imprintPage: string, aboutPage: string, privacyPolicyPage: string, faqPage?: string | null, tacPage?: string | null, homePageLink?: string | null, homePageStrategy: HomePageStrategy, currency: Currency, communicationEmail: string, settings: { __typename?: 'TenantSettings', showPWAInstall: boolean, enforcePolicyConsent: boolean, brandIconUrl?: string | null, esnCardLink?: string | null, socialLinks: Array<{ __typename?: 'ResourceLink', label: string, icon: string, url: string }>, sectionHubLinks: Array<{ __typename?: 'ResourceLink', label: string, icon: string, url: string }>, banners: Array<{ __typename?: 'BannerConfig', title: string, body: string, color: string, link: string, displayToMembershipStatus: Array<MembershipStatus> }>, deRegistrationOptions: { __typename?: 'GlobalDeRegistrationConfig', free: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean, movePossible: boolean, minimumDaysForMove: number, refundFeesOnMove: boolean } }, paid: { __typename?: 'DeRegistrationConfig', organizers: { __typename?: 'OrganizerDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean }, participants: { __typename?: 'ParticipantDeRegistrationSettings', deRegistrationPossible: boolean, minimumDaysForDeRegistration: number, refundFeesOnDeRegistration: boolean, movePossible: boolean, minimumDaysForMove: number, refundFeesOnMove: boolean } } } } } };
...
export type UpdateTenantMutation = { __typename?: 'Mutation', updateTenant: { __typename?: 'Tenant', id: string, faqPage?: string | null, imprintPage: string, privacyPolicyPage: string, aboutPage: string, tacPage?: string | null, homePageLink?: string | null, homePageStrategy: HomePageStrategy, currency: Currency, communicationEmail: string, settings: { __typename?: 'TenantSettings', brandIconUrl?: string | null, showPWAInstall: boolean, esnCardLink?: string | null, socialLinks: Array<{ __typename?: 'ResourceLink', label: string, icon: string, url: string }>, banners: Array<{ __typename?: 'BannerConfig', title: string, body: string, color: string, link: string, displayToMembershipStatus: Array<MembershipStatus> }>, sectionHubLinks: Array<{ __typename?: 'ResourceLink', label: string, icon: string, url: string }> } } };
...
export const GetInitialUserGridDataDocument = gql`
  ...
  export class GetInitialUserGridDataGQL extends Apollo.Query<GetInitialUserGridDataQuery, GetInitialUserGridDataQueryVariables> {
    override document = GetInitialUserGridDataDocument;
...
export const GetTenantCurrencyCodeDocument = gql`
  ...
  export class GetTenantCurrencyCodeGQL extends Apollo.Query<GetTenantCurrencyCodeQuery, GetTenantCurrencyCodeQueryVariables> {
...
export const GetAppStartupInfoDocument = gql`
  ...
  export class GetAppStartupInfoGQL extends Apollo.Query<GetAppStartupInfoQuery, GetAppStartupInfoQueryVariables> {
...
export const RegisterForEventDocument = gql`
    mutation registerForEvent($eventId: ID!, $type: RegistrationType, $submissions: JSON, $price: JSON, $guestCount: Int) {
  registerForEvent(
    eventId: $eventId
...
export const UseRegistrationEntryDocument = gql`
  ...
  export class UseRegistrationEntryGQL extends Apollo.Mutation<UseRegistrationEntryMutation, UseRegistrationEntryMutationVariables> {
    override document = UseRegistrationEntryDocument;
...
export const LoadEventDisplayDataDocument = gql`
  ...
  export class LoadEventDisplayDataGQL extends Apollo.Query<LoadEventDisplayDataQuery, LoadEventDisplayDataQueryVariables> {
...
export const GetEventListForShellDocument = gql`
  ...
  export class GetEventListForShellGQL extends Apollo.Query<GetEventListForShellQuery, GetEventListForShellQueryVariables> {
...
export const AdmitUserDocument = gql`
  ...
  export class AdmitUserGQL extends Apollo.Mutation<AdmitUserMutation, AdmitUserMutationVariables> {
    override document = AdmitUserDocument;
...
export const AddCostItemToEventDocument = gql`
  ...
  export class AddCostItemToEventGQL extends Apollo.Mutation<AddCostItemToEventMutation, AddCostItemToEventMutationVariables> {
...
export const GlobalAdminFeeOverviewDocument = gql`
    query globalAdminFeeOverview($currentMonth: String!, $lastMonth: String!, $monthBeforeLast: String!) {
  totalCollectedFees
  ...
  export class GlobalAdminFeeOverviewGQL extends Apollo.Query<GlobalAdminFeeOverviewQuery, GlobalAdminFeeOverviewQueryVariables> {
...
export const GetInitialGlobalStatisticsDataDocument = gql`
  ...
  export class GetInitialGlobalStatisticsDataGQL extends Apollo.Query<GetInitialGlobalStatisticsDataQuery, GetInitialGlobalStatisticsDataQueryVariables> {
...
export const GetGlobalRangeStatisticsDocument = gql`
    query getGlobalRangeStatistics($startDate: DateTime!, $endDate: DateTime!, $unit: String!) {
  rangeStatistics {
  ...
  userHistory: historicalStatistics(start: $startDate, end: $endDate, unit: $unit) {
    date
    usersRegistered
  }
...
export const GetTenantsForGlobalAdminDocument = gql`
  ...
  export class GetTenantsForGlobalAdminGQL extends Apollo.Query<GetTenantsForGlobalAdminQuery, GetTenantsForGlobalAdminQueryVariables> {
...
export const UpdateTenantContractEndDocument = gql`
    mutation updateTenantContractEnd($id: ID!, $contractEnd: DateTime!, $hardContractEnd: Boolean!) {
...
export const LoadCompleteProfileDataDocument = gql`
  ...
  export class LoadCompleteProfileDataGQL extends Apollo.Query<LoadCompleteProfileDataQuery, LoadCompleteProfileDataQueryVariables> {
...
export const CompleteProfileMutationDocument = gql`
  ...
  export class CompleteProfileMutationGQL extends Apollo.Mutation<CompleteProfileMutationMutation, CompleteProfileMutationMutationVariables> {
...
export const AddEsnCardDocument = gql`
  ...
  export class AddEsnCardGQL extends Apollo.Mutation<AddEsnCardMutation, AddEsnCardMutationVariables> {
...
export const LoadDeRegistrationSettingsDocument = gql`
  ...
  export class LoadDeRegistrationSettingsGQL extends Apollo.Query<LoadDeRegistrationSettingsQuery, LoadDeRegistrationSettingsQueryVariables> {
...
export const UpdateDeRegistrationSettingsDocument = gql`
  ...
  export class UpdateDeRegistrationSettingsGQL extends Apollo.Mutation<UpdateDeRegistrationSettingsMutation, UpdateDeRegistrationSettingsMutationVariables> {
...
export const LoadRegistrationDataSettingsDocument = gql`
  ...
  export class LoadRegistrationDataSettingsGQL extends Apollo.Query<LoadRegistrationDataSettingsQuery, LoadRegistrationDataSettingsQueryVariables> {
...
export const UpdateRegistrationDataSettingsDocument = gql`
  ...
  export class UpdateRegistrationDataSettingsGQL extends Apollo.Mutation<UpdateRegistrationDataSettingsMutation, UpdateRegistrationDataSettingsMutationVariables> {
...
export const LoadSectionSettingsDocument = gql`
  ...
  export class LoadSectionSettingsGQL extends Apollo.Query<LoadSectionSettingsQuery, LoadSectionSettingsQueryVariables> {
...
export const UpdateSectionSettingsDocument = gql`
  ...
  export class UpdateSectionSettingsGQL extends Apollo.Mutation<UpdateSectionSettingsMutation, UpdateSectionSettingsMutationVariables> {
...
export const LoadSiteContentSettingsDocument = gql`
  ...
  export class LoadSiteContentSettingsGQL extends Apollo.Query<LoadSiteContentSettingsQuery, LoadSiteContentSettingsQueryVariables> {
...
export const UpdateSiteContentSettingsDocument = gql`
  ...
  export class UpdateSiteContentSettingsGQL extends Apollo.Mutation<UpdateSiteContentSettingsMutation, UpdateSiteContentSettingsMutationVariables> {
...
export const UpdateEventTemplateCategoryDocument = gql`
    mutation UpdateEventTemplateCategory($id: ID!, $input: CreateEventTemplateCategoryInput!) {
  ...
  export class UpdateEventTemplateCategoryGQL extends Apollo.Mutation<UpdateEventTemplateCategoryMutation, UpdateEventTemplateCategoryMutationVariables> {
    override document = UpdateEventTemplateCategoryDocument;
...
export const GetLandingPageStatisticsDocument = gql`
    query getLandingPageStatistics($startDate: DateTime!, $middleDate: DateTime!, $endDate: DateTime!) {
  rangeStatistics {
  ...
  export class GetLandingPageStatisticsGQL extends Apollo.Query<GetLandingPageStatisticsQuery, GetLandingPageStatisticsQueryVariables> {
...
export const UpdateOrganizerDocument = gql`
  ...
  export class UpdateOrganizerGQL extends Apollo.Mutation<UpdateOrganizerMutation, UpdateOrganizerMutationVariables> {
    override document = UpdateOrganizerDocument;
...
export const GetInitialStatisticsDataDocument = gql`
  ...
  export class GetInitialStatisticsDataGQL extends Apollo.Query<GetInitialStatisticsDataQuery, GetInitialStatisticsDataQueryVariables> {
    override document = GetInitialStatisticsDataDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const GetRangeStatisticsDocument = gql`
    query getRangeStatistics($startDate: DateTime!, $endDate: DateTime!, $unit: String!) {
  rangeStatistics {
    registeredUsers(start: $startDate, end: $endDate)
    eventsStarted(start: $startDate, end: $endDate)
    registeredParticipants(start: $startDate, end: $endDate)
  ...
  export class GetRangeStatisticsGQL extends Apollo.Query<GetRangeStatisticsQuery, GetRangeStatisticsQueryVariables> {
    override document = GetRangeStatisticsDocument;
...
export const GetInitialAdminUsersDataDocument = gql`
  ...
  export class GetInitialAdminUsersDataGQL extends Apollo.Query<GetInitialAdminUsersDataQuery, GetInitialAdminUsersDataQueryVariables> {
    override document = GetInitialAdminUsersDataDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const GetUsersForAdminGridDocument = gql`
    query getUsersForAdminGrid($startRow: Int!, $endRow: Int!, $sortModel: [SortModelInput!]!, $filterModel: JSONObject!) {
  gridUsers(
    startRow: $startRow
    endRow: $endRow
    sortModel: $sortModel
  ...
  export class GetUsersForAdminGridGQL extends Apollo.Query<GetUsersForAdminGridQuery, GetUsersForAdminGridQueryVariables> {
    override document = GetUsersForAdminGridDocument;
