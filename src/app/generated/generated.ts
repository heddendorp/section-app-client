...
export type GetAppStartupInfoQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, currency: Currency, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', label: string, options: Array<string>, type: string }>, banners: Array<{ __typename?: 'BannerConfig', title: string, body: string, color: string, link: string, displayToMembershipStatus: Array<MembershipStatus> }> } } };
...
export type GlobalAdminFeeOverviewQuery = { __typename?: 'Query', totalCollectedFees: number, currentMonth: number, lastMonth: number, monthBeforeLast: number, tenantFeeMonths: Array<{ __typename?: 'TenantFeeMonth', amount: number, amountRefunded: number, netAmount: number, tenantName: string, month: string, transactionCount: number }> };
