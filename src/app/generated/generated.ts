...
export type GetRegistrationQuery = { __typename?: 'Query', registration: { __typename?: 'EventRegistration', id: string, type: RegistrationType, didAttend: boolean, checkInTime?: string | null, transactions: Array<{ __typename?: 'Transaction', id: string, status: TransactionStatus, direction: TransactionDirection, amount: any, type: TransactionType, subject: string, stripePayment?: { __typename?: 'StripePayment', id: string, status: string } | null }>, event: { __typename?: 'TumiEvent', id: string, title: string, icon: string }, user: { __typename?: 'User', id: string, fullName: string, picture: string, esnCardNumber?: string | null, esnCardValidUntil?: string | null } } };
...
export type UpdateCoreEventMutation = { __typename?: 'Mutation', updateEventCoreInfo: { __typename?: 'TumiEvent', id: string, title: string, icon: string, start: string, end: string, registrationStart: string, prices?: any | null, registrationMode: RegistrationMode, registrationLink?: string | null, eventOrganizerId: string, organizerSignup: Array<string>, participantSignup: Array<string>, participantLimit: number, organizerLimit: number, excludeFromRatings: boolean, excludeFromStatistics: boolean, enablePhotoSharing: boolean } };
...
export type LoadCompleteProfileDataQuery = { __typename?: 'Query', currentTenant: { __typename?: 'Tenant', id: string, name: string, settings: { __typename?: 'TenantSettings', userDataCollection: Array<{ __typename?: 'DynamicFormField', type: string, options: Array<string>, label: string }> } }, currentUser?: { __typename?: 'User', id: string, firstName: string, lastName: string, email: string, communicationEmail?: string | null, birthdate?: string | null, additionalData: any } | null };
...
export type CompleteProfileMutationMutation = { __typename?: 'Mutation', completeProfile: { __typename?: 'User', id: string, firstName: string, lastName: string, email: string, birthdate?: string | null, additionalData: any } };
...
export type UserProfileQuery = { __typename?: 'Query', currentUser?: { __typename?: 'User', id: string, fullName: string, picture: string, emailVerified: boolean, email: string, communicationEmail?: string | null, iban?: string | null, paypal?: string | null, birthdate?: string | null, firstName: string, lastName: string, calendarToken: string, esnCardNumber?: string | null, esnCardValidUntil?: string | null, position?: string | null, additionalData: any, status: MembershipStatus, organizedEventsCount: number, createdEventsCount: number } | null, currentTenant: { __typename?: 'Tenant', settings: { __typename?: 'TenantSettings', esnCardLink?: string | null } } };
...
export type UpdateProfileMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', id: string, firstName: string, lastName: string, fullName: string } };
...
export type UpdateUserInformationMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', id: string, communicationEmail?: string | null } };
