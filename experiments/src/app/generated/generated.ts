...
export type LoadPreviewEventsQueryVariables = Exact<{ [key: string]: never }>;

export type LoadPreviewEventsQuery = {
  __typename?: 'Query';
  events: Array<{
    __typename?: 'TumiEvent';
    id: string;
...
export const LoadPreviewEventsDocument = gql`
  query LoadPreviewEvents {
    events {
      id
      title
      icon
...
export class LoadPreviewEventsGQL extends Apollo.Query<
  LoadPreviewEventsQuery,
  LoadPreviewEventsQueryVariables
> {
  override document = LoadPreviewEventsDocument;
