...
export type CreateEventFromTemplateMutation = {
  __typename?: 'Mutation';
  createEventFromTemplate?: { __typename?: 'TumiEvent'; id: string } | null;
};
...
export type DeleteEventTemplateMutation = {
  __typename?: 'Mutation';
  deleteTemplate?: { __typename?: 'EventTemplate'; id: string } | null;
};
...
export type LoadRegistrationForMoveQuery = {
  ...
  registration: {
    ...
    id: string;
    eventId: string;
    deletingCode?: { __typename?: 'EventRegistrationCode'; id: string } | null;
  };
};
...
export type LoadEventForManagementQuery = {
  ...
  event: {
    ...
    feesPaid: any;
    plannedSpend?: any | null;
    submittedSpend?: any | null;
    participantLimit: number;
    participantsRegistered: number;
    participantsAttended: number;
    costItems: Array<{
...
export type LoadEventForEditQuery = {
  ...
  event: {
    ...
    organizerRegistrations: Array<{
      __typename?: 'EventRegistration';
      id: string;
      user: { __typename?: 'User'; picture: string; fullName: string };
    }>;
    organizers: Array<{
      __typename?: 'User';
      fullName: string;
...
export type CreatePhotoShareMutation = {
  __typename?: 'Mutation';
  createPhotoShare?: { __typename?: 'PhotoShare'; id: string } | null;
};
...
export type GetEventRegistrationCodesQuery = {
  ...
  eventRegistrationCodes: Array<{
    ...
    isPublic: boolean;
    status: RegistrationStatus;
    targetEvent: { __typename?: 'TumiEvent'; id: string; title: string };
    creator: { __typename?: 'User'; id: string; fullName: string };
...
export type CreateOrganizerMutation = {
  __typename?: 'Mutation';
  createEventOrganizer?: { __typename?: 'EventOrganizer'; id: string } | null;
};

export type LoadEventsForInsuranceQueryVariables = Exact<{
  [key: string]: never;
}>;

export type LoadEventsForInsuranceQuery = {
  __typename?: 'Query';
  events: Array<{
    __typename?: 'TumiEvent';
    id: string;
...
export type GetUsersQueryVariables = Exact<{
  ...
  statusList?: InputMaybe<
    Array<InputMaybe<MembershipStatus>> | InputMaybe<MembershipStatus>
  >;
  search?: InputMaybe<Scalars['String']>;
  pageIndex?: InputMaybe<Scalars['Int']>;
  pageLength?: InputMaybe<Scalars['Int']>;
...
export type GetStatisticsQuery = {
  ...
  currentTenant?: {
    ...
    statistics: {
      ...
      usersWithCustomer: number;
      usersWithPaymentMethod: number;
      registrations: number;
      userHistory: Array<any>;
      registrationHistory: Array<any>;
      refundHistory: Array<any>;
      userEventDistribution: Array<any>;
      ...
      totalEvents: number;
      paidEvents: number;
      userUniversityDistribution: Array<any>;
    };
  } | null;
};
...
export type GetTenantPurchasesQuery = {
  __typename?: 'Query';
  purchases: Array<{
    __typename?: 'Purchase';
    id: string;
...
export class LoadEventsForInsuranceGQL extends Apollo.Query<
  LoadEventsForInsuranceQuery,
  LoadEventsForInsuranceQueryVariables
> {
...
export class GetLogsGQL extends Apollo.Query<
  GetLogsQuery,
...
export class GetTenantPurchasesGQL extends Apollo.Query<
  GetTenantPurchasesQuery,
  GetTenantPurchasesQueryVariables
> {
...
export class GetPurchaseGQL extends Apollo.Query<
  GetPurchaseQuery,
