...
@Component({
  selector: 'tumi-event-scan-page',
  templateUrl: './event-scan-page.component.html',
  styleUrls: ['./event-scan-page.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EventScanPageComponent implements AfterViewInit, OnDestroy {
