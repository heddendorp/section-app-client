...
export type LoadEventQuery = { __typename?: 'Query', event?: Maybe<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any, end: any, description: string, organizerText: string, registrationMode: RegistrationMode, registrationLink?: Maybe<string>, price?: Maybe<any>, organizerSignup: Array<MembershipStatus>, participantSignup: Array<MembershipStatus>, organizerRegistrationPossible?: Maybe<boolean>, couldBeOrganizer?: Maybe<boolean>, couldBeParticipant?: Maybe<boolean>, organizer: { __typename?: 'EventOrganizer', link?: Maybe<string>, text: string }, organizers: Array<{ __typename?: 'User', fullName: string }> }> };
...
export type UserProfileQuery = { __typename?: 'Query', currentUser?: Maybe<{ __typename?: 'User', id: string, fullName: string, picture: string, email_verified: boolean, email: string, birthdate: any, firstName: string, currentTenant?: Maybe<{ __typename?: 'UsersOfTenants', status: MembershipStatus }>, organizedEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any }> }> };
