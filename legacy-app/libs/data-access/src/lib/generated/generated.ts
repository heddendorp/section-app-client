...
export type MutationRegisterWithStripeArgs = {
  id: Scalars['ID'];
};
...
export type LoadEventQuery = { __typename?: 'Query', event?: Maybe<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any, end: any, publicationState: PublicationState, description: string, organizerText: string, registrationMode: RegistrationMode, registrationLink?: Maybe<string>, price?: Maybe<any>, organizerSignup: Array<MembershipStatus>, participantSignup: Array<MembershipStatus>, organizerRegistrationPossible?: Maybe<boolean>, participantRegistrationPossible?: Maybe<boolean>, userRegistered: boolean, participantLimit: number, participantsRegistered?: Maybe<number>, couldBeOrganizer?: Maybe<boolean>, couldBeParticipant?: Maybe<boolean>, organizer: { __typename?: 'EventOrganizer', link?: Maybe<string>, text: string }, organizers: Array<{ __typename?: 'User', fullName: string }> }> };
...
export type LoadEventForEditQuery = { __typename?: 'Query', event?: Maybe<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any, end: any, description: string, organizerText: string, registrationMode: RegistrationMode, price?: Maybe<any>, eventOrganizerId: string, organizerSignup: Array<MembershipStatus>, participantSignup: Array<MembershipStatus>, organizerRegistrationPossible?: Maybe<boolean>, couldBeOrganizer?: Maybe<boolean>, couldBeParticipant?: Maybe<boolean>, participantLimit: number, organizerLimit: number, publicationState: PublicationState, registrationLink?: Maybe<string>, organizers: Array<{ __typename?: 'User', fullName: string, picture: string, id: string }> }>, organizers: Array<{ __typename?: 'EventOrganizer', id: string, name: string }> };

export type GetUserPaymentStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserPaymentStatusQuery = { __typename?: 'Query', currentUser?: Maybe<{ __typename?: 'User', currentTenant?: Maybe<{ __typename?: 'UsersOfTenants', stripeData?: Maybe<{ __typename?: 'StripeUserData', paymentMethodId?: Maybe<string> }> }> }> };

export type RegisterWithStripePaymentMutationVariables = Exact<{
  eventId: Scalars['ID'];
}>;


export type RegisterWithStripePaymentMutation = { __typename?: 'Mutation', registerWithStripe: { __typename?: 'paymentIntent', id: string, status: string, client_secret?: Maybe<string> } };
...
export type UpdatePublicationMutation = { __typename?: 'Mutation', changeEventPublication?: Maybe<{ __typename?: 'TumiEvent', id: string, publicationState: PublicationState }> };
...
export type RegisterForEventMutation = { __typename?: 'Mutation', registerForEvent?: Maybe<{ __typename?: 'TumiEvent', id: string, organizerRegistrationPossible?: Maybe<boolean>, participantRegistrationPossible?: Maybe<boolean>, organizersRegistered?: Maybe<number>, participantsRegistered?: Maybe<number>, couldBeOrganizer?: Maybe<boolean>, userRegistered: boolean, organizers: Array<{ __typename?: 'User', fullName: string }> }> };

export type EventListQueryVariables = Exact<{ [key: string]: never; }>;


export type EventListQuery = { __typename?: 'Query', events: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any, participantLimit: number, participantsRegistered?: Maybe<number>, organizerLimit: number, organizersRegistered?: Maybe<number>, couldBeOrganizer?: Maybe<boolean>, couldBeParticipant?: Maybe<boolean>, publicationState: PublicationState, registrationMode: RegistrationMode }> };
...
export type UserProfileQuery = { __typename?: 'Query', currentUser?: Maybe<{ __typename?: 'User', id: string, fullName: string, picture: string, email_verified: boolean, email: string, birthdate: any, firstName: string, currentTenant?: Maybe<{ __typename?: 'UsersOfTenants', status: MembershipStatus, stripeData?: Maybe<{ __typename?: 'StripeUserData', paymentMethodId?: Maybe<string> }> }>, organizedEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any }>, participatedEvents: Array<{ __typename?: 'TumiEvent', id: string, title: string, icon: string, start: any }> }> };
...
export const GetUserPaymentStatusDocument = gql`
  ...
  export class GetUserPaymentStatusGQL extends Apollo.Query<GetUserPaymentStatusQuery, GetUserPaymentStatusQueryVariables> {
    document = GetUserPaymentStatusDocument;

    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const RegisterWithStripePaymentDocument = gql`
  ...
  export class RegisterWithStripePaymentGQL extends Apollo.Mutation<RegisterWithStripePaymentMutation, RegisterWithStripePaymentMutationVariables> {
    document = RegisterWithStripePaymentDocument;
