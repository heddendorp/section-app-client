...
export namespace Prisma {
  ...
  */
  ...
  export type TenantCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof TenantCountOutputType ?TenantCountOutputType [P]
  : 
     never
  } 
    : TenantCountOutputType
  ...
  export type EventOrganizerCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventOrganizerCountOutputType ?EventOrganizerCountOutputType [P]
  : 
     never
  } 
    : EventOrganizerCountOutputType
  ...
  export type EventTemplateCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventTemplateCountOutputType ?EventTemplateCountOutputType [P]
  : 
     never
  } 
    : EventTemplateCountOutputType
  ...
  export type TumiEventCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof TumiEventCountOutputType ?TumiEventCountOutputType [P]
  : 
     never
  } 
    : TumiEventCountOutputType
  ...
  export type CostItemCountOutputTypeGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof CostItemCountOutputType ?CostItemCountOutputType [P]
  : 
     never
  } 
    : CostItemCountOutputType
  ...
  export type EventSubmissionItemCountOutputTypeGetPayload<
    S extends boolean | null | undefined | EventSubmissionItemCountOutputTypeArgs,
    U = keyof S
      > = S extends true
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventSubmissionItemCountOutputType ?EventSubmissionItemCountOutputType [P]
  : 
     never
  } 
    : EventSubmissionItemCountOutputType
  ...
  export type TenantGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends '_count'
        ? TenantCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends '_count'
        ? TenantCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : Tenant
  : Tenant
  ...
  export class Prisma__TenantClient<T> implements PrismaPromise<T> {
    ...
    users<T extends UsersOfTenantsFindManyArgs = {}>(args?: Subset<T, UsersOfTenantsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<UsersOfTenants>>, PrismaPromise<Array<UsersOfTenantsGetPayload<T>>>>;

    eventTemplates<T extends EventTemplateFindManyArgs = {}>(args?: Subset<T, EventTemplateFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventTemplate>>, PrismaPromise<Array<EventTemplateGetPayload<T>>>>;

    organizers<T extends EventOrganizerFindManyArgs = {}>(args?: Subset<T, EventOrganizerFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventOrganizer>>, PrismaPromise<Array<EventOrganizerGetPayload<T>>>>;
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    tenants<T extends UsersOfTenantsFindManyArgs = {}>(args?: Subset<T, UsersOfTenantsFindManyArgs>): CheckSelect<T, PrismaPromise<Array<UsersOfTenants>>, PrismaPromise<Array<UsersOfTenantsGetPayload<T>>>>;

    eventSubmissions<T extends EventSubmissionFindManyArgs = {}>(args?: Subset<T, EventSubmissionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventSubmission>>, PrismaPromise<Array<EventSubmissionGetPayload<T>>>>;

    eventRegistrations<T extends EventRegistrationFindManyArgs = {}>(args?: Subset<T, EventRegistrationFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventRegistration>>, PrismaPromise<Array<EventRegistrationGetPayload<T>>>>;

    receipts<T extends ReceiptFindManyArgs = {}>(args?: Subset<T, ReceiptFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Receipt>>, PrismaPromise<Array<ReceiptGetPayload<T>>>>;

    createdEvents<T extends TumiEventFindManyArgs = {}>(args?: Subset<T, TumiEventFindManyArgs>): CheckSelect<T, PrismaPromise<Array<TumiEvent>>, PrismaPromise<Array<TumiEventGetPayload<T>>>>;
  ...
  export type GetUsersOfTenantsAggregateType<T extends UsersOfTenantsAggregateArgs> = {
  ...
  type GetUsersOfTenantsGroupByPayload<T extends UsersOfTenantsGroupByArgs> = Promise<
    Array<
      PickArray<UsersOfTenantsGroupByOutputType, T['by']> & 
        {
          [P in ((keyof T) & (keyof UsersOfTenantsGroupByOutputType))]: P extends '_count' 
            ? T[P] extends boolean 
              ? number 
  ...
  export type UsersOfTenantsGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof UsersOfTenants ?UsersOfTenants [P]
  : 
          P extends 'user'
  ...
  export interface UsersOfTenantsDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends UsersOfTenantsFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, UsersOfTenantsFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'UsersOfTenants'> extends True ? CheckSelect<T, Prisma__UsersOfTenantsClient<UsersOfTenants>, Prisma__UsersOfTenantsClient<UsersOfTenantsGetPayload<T>>> : CheckSelect<T, Prisma__UsersOfTenantsClient<UsersOfTenants | null >, Prisma__UsersOfTenantsClient<UsersOfTenantsGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends UsersOfTenantsFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, UsersOfTenantsFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'UsersOfTenants'> extends True ? CheckSelect<T, Prisma__UsersOfTenantsClient<UsersOfTenants>, Prisma__UsersOfTenantsClient<UsersOfTenantsGetPayload<T>>> : CheckSelect<T, Prisma__UsersOfTenantsClient<UsersOfTenants | null >, Prisma__UsersOfTenantsClient<UsersOfTenantsGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<UsersOfTenants>>, PrismaPromise<Array<UsersOfTenantsGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__UsersOfTenantsClient<UsersOfTenants>, Prisma__UsersOfTenantsClient<UsersOfTenantsGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends UsersOfTenantsAggregateArgs>(args: Subset<T, UsersOfTenantsAggregateArgs>): PrismaPromise<GetUsersOfTenantsAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, UsersOfTenantsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUsersOfTenantsGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type UsersOfTenantsUpdateManyArgs = {
    data: XOR<UsersOfTenantsUpdateManyMutationInput, UsersOfTenantsUncheckedUpdateManyInput>
    where?: UsersOfTenantsWhereInput
  }
  ...
  type GetEventOrganizerGroupByPayload<T extends EventOrganizerGroupByArgs> = Promise<
    Array<
  ...
  export type EventOrganizerGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < TumiEventGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? EventOrganizerCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventOrganizer ?EventOrganizer [P]
  : 
          P extends 'tenant'
        ...
        ? Array < TumiEventGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? EventOrganizerCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : EventOrganizer
  : EventOrganizer
  ...
  export interface EventOrganizerDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends EventOrganizerFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventOrganizerFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventOrganizer'> extends True ? CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer>, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T>>> : CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer | null >, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends EventOrganizerFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventOrganizerFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventOrganizer'> extends True ? CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer>, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T>>> : CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer | null >, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<EventOrganizer>>, PrismaPromise<Array<EventOrganizerGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer>, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends EventOrganizerAggregateArgs>(args: Subset<T, EventOrganizerAggregateArgs>): PrismaPromise<GetEventOrganizerAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EventOrganizerGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventOrganizerGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export class Prisma__EventOrganizerClient<T> implements PrismaPromise<T> {
    ...
    events<T extends TumiEventFindManyArgs = {}>(args?: Subset<T, TumiEventFindManyArgs>): CheckSelect<T, PrismaPromise<Array<TumiEvent>>, PrismaPromise<Array<TumiEventGetPayload<T>>>>;
  ...
  type GetEventTemplateGroupByPayload<T extends EventTemplateGroupByArgs> = Promise<
    Array<
  ...
  export type EventTemplateGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? TenantGetPayload<S['include'][P]> :
        P extends '_count'
        ? EventTemplateCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventTemplate ?EventTemplate [P]
  : 
          P extends 'eventInstances'
        ? Array < TumiEventGetPayload<S['select'][P]>>  :
        P extends 'tenant'
        ? TenantGetPayload<S['select'][P]> :
        P extends '_count'
        ? EventTemplateCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : EventTemplate
  : EventTemplate
  ...
  export interface EventTemplateDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends EventTemplateFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventTemplateFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventTemplate'> extends True ? CheckSelect<T, Prisma__EventTemplateClient<EventTemplate>, Prisma__EventTemplateClient<EventTemplateGetPayload<T>>> : CheckSelect<T, Prisma__EventTemplateClient<EventTemplate | null >, Prisma__EventTemplateClient<EventTemplateGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends EventTemplateFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventTemplateFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventTemplate'> extends True ? CheckSelect<T, Prisma__EventTemplateClient<EventTemplate>, Prisma__EventTemplateClient<EventTemplateGetPayload<T>>> : CheckSelect<T, Prisma__EventTemplateClient<EventTemplate | null >, Prisma__EventTemplateClient<EventTemplateGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<EventTemplate>>, PrismaPromise<Array<EventTemplateGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__EventTemplateClient<EventTemplate>, Prisma__EventTemplateClient<EventTemplateGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends EventTemplateAggregateArgs>(args: Subset<T, EventTemplateAggregateArgs>): PrismaPromise<GetEventTemplateAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EventTemplateGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventTemplateGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export class Prisma__EventTemplateClient<T> implements PrismaPromise<T> {
    ...
    eventInstances<T extends TumiEventFindManyArgs = {}>(args?: Subset<T, TumiEventFindManyArgs>): CheckSelect<T, PrismaPromise<Array<TumiEvent>>, PrismaPromise<Array<TumiEventGetPayload<T>>>>;
  ...
  export type TumiEventGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        P extends '_count'
        ? TumiEventCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof TumiEvent ?TumiEvent [P]
  : 
          P extends 'submissionItems'
        ...
        P extends '_count'
        ? TumiEventCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : TumiEvent
  : TumiEvent
  ...
  export interface TumiEventDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends TumiEventFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, TumiEventFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'TumiEvent'> extends True ? CheckSelect<T, Prisma__TumiEventClient<TumiEvent>, Prisma__TumiEventClient<TumiEventGetPayload<T>>> : CheckSelect<T, Prisma__TumiEventClient<TumiEvent | null >, Prisma__TumiEventClient<TumiEventGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends TumiEventFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, TumiEventFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'TumiEvent'> extends True ? CheckSelect<T, Prisma__TumiEventClient<TumiEvent>, Prisma__TumiEventClient<TumiEventGetPayload<T>>> : CheckSelect<T, Prisma__TumiEventClient<TumiEvent | null >, Prisma__TumiEventClient<TumiEventGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<TumiEvent>>, PrismaPromise<Array<TumiEventGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__TumiEventClient<TumiEvent>, Prisma__TumiEventClient<TumiEventGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends TumiEventAggregateArgs>(args: Subset<T, TumiEventAggregateArgs>): PrismaPromise<GetTumiEventAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, TumiEventGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTumiEventGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export class Prisma__TumiEventClient<T> implements PrismaPromise<T> {
    ...
    submissionItems<T extends EventSubmissionItemFindManyArgs = {}>(args?: Subset<T, EventSubmissionItemFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventSubmissionItem>>, PrismaPromise<Array<EventSubmissionItemGetPayload<T>>>>;

    registrations<T extends EventRegistrationFindManyArgs = {}>(args?: Subset<T, EventRegistrationFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventRegistration>>, PrismaPromise<Array<EventRegistrationGetPayload<T>>>>;

    costItems<T extends CostItemFindManyArgs = {}>(args?: Subset<T, CostItemFindManyArgs>): CheckSelect<T, PrismaPromise<Array<CostItem>>, PrismaPromise<Array<CostItemGetPayload<T>>>>;

    photoShare<T extends PhotoShareArgs = {}>(args?: Subset<T, PhotoShareArgs>): CheckSelect<T, Prisma__PhotoShareClient<PhotoShare | null >, Prisma__PhotoShareClient<PhotoShareGetPayload<T> | null >>;

    organizer<T extends EventOrganizerArgs = {}>(args?: Subset<T, EventOrganizerArgs>): CheckSelect<T, Prisma__EventOrganizerClient<EventOrganizer | null >, Prisma__EventOrganizerClient<EventOrganizerGetPayload<T> | null >>;
    ...
    eventTemplate<T extends EventTemplateArgs = {}>(args?: Subset<T, EventTemplateArgs>): CheckSelect<T, Prisma__EventTemplateClient<EventTemplate | null >, Prisma__EventTemplateClient<EventTemplateGetPayload<T> | null >>;
  ...
  export type TumiEventUpdateManyArgs = {
    data: XOR<TumiEventUpdateManyMutationInput, TumiEventUncheckedUpdateManyInput>
    where?: TumiEventWhereInput
  }
  ...
  export type CostItemGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < ReceiptGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? CostItemCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof CostItem ?CostItem [P]
  : 
          P extends 'event'
        ...
        ? Array < ReceiptGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? CostItemCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : CostItem
  : CostItem
  ...
  export interface CostItemDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends CostItemFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CostItemFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'CostItem'> extends True ? CheckSelect<T, Prisma__CostItemClient<CostItem>, Prisma__CostItemClient<CostItemGetPayload<T>>> : CheckSelect<T, Prisma__CostItemClient<CostItem | null >, Prisma__CostItemClient<CostItemGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends CostItemFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CostItemFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'CostItem'> extends True ? CheckSelect<T, Prisma__CostItemClient<CostItem>, Prisma__CostItemClient<CostItemGetPayload<T>>> : CheckSelect<T, Prisma__CostItemClient<CostItem | null >, Prisma__CostItemClient<CostItemGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<CostItem>>, PrismaPromise<Array<CostItemGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__CostItemClient<CostItem>, Prisma__CostItemClient<CostItemGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CostItemAggregateArgs>(args: Subset<T, CostItemAggregateArgs>): PrismaPromise<GetCostItemAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CostItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCostItemGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export class Prisma__CostItemClient<T> implements PrismaPromise<T> {
    ...
    event<T extends TumiEventArgs = {}>(args?: Subset<T, TumiEventArgs>): CheckSelect<T, Prisma__TumiEventClient<TumiEvent | null >, Prisma__TumiEventClient<TumiEventGetPayload<T> | null >>;
  ...
  export type ReceiptGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? UserGetPayload<S['include'][P]> :
        P extends 'costItem'
        ? CostItemGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        ? UserGetPayload<S['select'][P]> :
        P extends 'costItem'
        ? CostItemGetPayload<S['select'][P]> : never
  } 
    : Receipt
  : Receipt
  ...
  export class Prisma__ReceiptClient<T> implements PrismaPromise<T> {
    ...
    costItem<T extends CostItemArgs = {}>(args?: Subset<T, CostItemArgs>): CheckSelect<T, Prisma__CostItemClient<CostItem | null >, Prisma__CostItemClient<CostItemGetPayload<T> | null >>;
  ...
  export type PhotoShareGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
          P extends 'event'
        ? TumiEventGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof PhotoShare ?PhotoShare [P]
  : 
          P extends 'event'
        ? TumiEventGetPayload<S['select'][P]> : never
  } 
    : PhotoShare
  : PhotoShare
  ...
  export interface PhotoShareDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends PhotoShareFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, PhotoShareFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'PhotoShare'> extends True ? CheckSelect<T, Prisma__PhotoShareClient<PhotoShare>, Prisma__PhotoShareClient<PhotoShareGetPayload<T>>> : CheckSelect<T, Prisma__PhotoShareClient<PhotoShare | null >, Prisma__PhotoShareClient<PhotoShareGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends PhotoShareFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, PhotoShareFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'PhotoShare'> extends True ? CheckSelect<T, Prisma__PhotoShareClient<PhotoShare>, Prisma__PhotoShareClient<PhotoShareGetPayload<T>>> : CheckSelect<T, Prisma__PhotoShareClient<PhotoShare | null >, Prisma__PhotoShareClient<PhotoShareGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<PhotoShare>>, PrismaPromise<Array<PhotoShareGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__PhotoShareClient<PhotoShare>, Prisma__PhotoShareClient<PhotoShareGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends PhotoShareAggregateArgs>(args: Subset<T, PhotoShareAggregateArgs>): PrismaPromise<GetPhotoShareAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, PhotoShareGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPhotoShareGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type PhotoShareUpdateManyArgs = {
    data: XOR<PhotoShareUpdateManyMutationInput, PhotoShareUncheckedUpdateManyInput>
    where?: PhotoShareWhereInput
  }
  ...
  export type GetEventSubmissionItemAggregateType<T extends EventSubmissionItemAggregateArgs> = {
        [P in keyof T & keyof AggregateEventSubmissionItem]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
  ...
  type GetEventSubmissionItemGroupByPayload<T extends EventSubmissionItemGroupByArgs> = Promise<
    Array<
      PickArray<EventSubmissionItemGroupByOutputType, T['by']> & 
        {
          [P in ((keyof T) & (keyof EventSubmissionItemGroupByOutputType))]: P extends '_count' 
            ? T[P] extends boolean 
              ? number 
  ...
  export type EventSubmissionItemGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < EventSubmissionGetPayload<S['include'][P]>>  :
        P extends '_count'
        ? EventSubmissionItemCountOutputTypeGetPayload<S['include'][P]> | null : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventSubmissionItem ?EventSubmissionItem [P]
  : 
          P extends 'event'
        ? TumiEventGetPayload<S['select'][P]> :
        P extends 'submissions'
        ? Array < EventSubmissionGetPayload<S['select'][P]>>  :
        P extends '_count'
        ? EventSubmissionItemCountOutputTypeGetPayload<S['select'][P]> | null : never
  } 
    : EventSubmissionItem
  : EventSubmissionItem
  ...
  export interface EventSubmissionItemDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends EventSubmissionItemFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventSubmissionItemFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventSubmissionItem'> extends True ? CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem>, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T>>> : CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem | null >, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends EventSubmissionItemFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventSubmissionItemFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventSubmissionItem'> extends True ? CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem>, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T>>> : CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem | null >, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<EventSubmissionItem>>, PrismaPromise<Array<EventSubmissionItemGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem>, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T>>>
    ...
    **/
    count<T extends EventSubmissionItemCountArgs>(
      ...
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], EventSubmissionItemCountAggregateOutputType>
        : number
    >
     ...
     * })
    **/
    aggregate<T extends EventSubmissionItemAggregateArgs>(args: Subset<T, EventSubmissionItemAggregateArgs>): PrismaPromise<GetEventSubmissionItemAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EventSubmissionItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventSubmissionItemGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__EventSubmissionItemClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
    ...
    submissions<T extends EventSubmissionFindManyArgs = {}>(args?: Subset<T, EventSubmissionFindManyArgs>): CheckSelect<T, PrismaPromise<Array<EventSubmission>>, PrismaPromise<Array<EventSubmissionGetPayload<T>>>>;
  ...
  export type EventSubmissionItemCreateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<EventSubmissionItemCreateInput, EventSubmissionItemUncheckedCreateInput>
  }
  ...
  export type EventSubmissionItemUpdateArgs = {
    ...
    **/
     ...
     * 
    **/
    data: XOR<EventSubmissionItemUpdateInput, EventSubmissionItemUncheckedUpdateInput>
    /**
  ...
  export type EventSubmissionItemUpdateManyArgs = {
    data: XOR<EventSubmissionItemUpdateManyMutationInput, EventSubmissionItemUncheckedUpdateManyInput>
    where?: EventSubmissionItemWhereInput
  }
  ...
  export type EventSubmissionItemUpsertArgs = {
    ...
    **/
     ...
     * 
    **/
    create: XOR<EventSubmissionItemCreateInput, EventSubmissionItemUncheckedCreateInput>
    /**
     * In case the EventSubmissionItem was found with the provided `where` argument, update it with this data.
     * 
    **/
    update: XOR<EventSubmissionItemUpdateInput, EventSubmissionItemUncheckedUpdateInput>
  }
  ...
  type GetEventSubmissionGroupByPayload<T extends EventSubmissionGroupByArgs> = Promise<
    Array<
  ...
  export type EventSubmissionGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? EventSubmissionItemGetPayload<S['include'][P]> : never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof EventSubmission ?EventSubmission [P]
  : 
          P extends 'user'
        ? UserGetPayload<S['select'][P]> :
        P extends 'submissionItem'
        ? EventSubmissionItemGetPayload<S['select'][P]> : never
  } 
    : EventSubmission
  : EventSubmission
  ...
  export interface EventSubmissionDelegate<GlobalRejectSettings> {
     ...
     * })
    **/
    findUnique<T extends EventSubmissionFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventSubmissionFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventSubmission'> extends True ? CheckSelect<T, Prisma__EventSubmissionClient<EventSubmission>, Prisma__EventSubmissionClient<EventSubmissionGetPayload<T>>> : CheckSelect<T, Prisma__EventSubmissionClient<EventSubmission | null >, Prisma__EventSubmissionClient<EventSubmissionGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends EventSubmissionFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventSubmissionFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventSubmission'> extends True ? CheckSelect<T, Prisma__EventSubmissionClient<EventSubmission>, Prisma__EventSubmissionClient<EventSubmissionGetPayload<T>>> : CheckSelect<T, Prisma__EventSubmissionClient<EventSubmission | null >, Prisma__EventSubmissionClient<EventSubmissionGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<EventSubmission>>, PrismaPromise<Array<EventSubmissionGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__EventSubmissionClient<EventSubmission>, Prisma__EventSubmissionClient<EventSubmissionGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends EventSubmissionAggregateArgs>(args: Subset<T, EventSubmissionAggregateArgs>): PrismaPromise<GetEventSubmissionAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EventSubmissionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEventSubmissionGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export class Prisma__EventSubmissionClient<T> implements PrismaPromise<T> {
    ...
    submissionItem<T extends EventSubmissionItemArgs = {}>(args?: Subset<T, EventSubmissionItemArgs>): CheckSelect<T, Prisma__EventSubmissionItemClient<EventSubmissionItem | null >, Prisma__EventSubmissionItemClient<EventSubmissionItemGetPayload<T> | null >>;
  ...
  export type UsersOfTenantsScalarFieldEnum = (typeof UsersOfTenantsScalarFieldEnum)[keyof typeof UsersOfTenantsScalarFieldEnum]
  ...
  export type TumiEventScalarFieldEnum = (typeof TumiEventScalarFieldEnum)[keyof typeof TumiEventScalarFieldEnum]
  ...
  export type PhotoShareScalarFieldEnum = (typeof PhotoShareScalarFieldEnum)[keyof typeof PhotoShareScalarFieldEnum]
  ...
  export type EventSubmissionItemScalarFieldEnum = (typeof EventSubmissionItemScalarFieldEnum)[keyof typeof EventSubmissionItemScalarFieldEnum]
  ...
  export type TumiEventScalarWhereWithAggregatesInput = {
    ...
    publicationState?: EnumPublicationStateWithAggregatesFilter | PublicationState
    participantSignup?: EnumMembershipStatusNullableListFilter
    organizerSignup?: EnumMembershipStatusNullableListFilter
  ...
  export type EventSubmissionWhereInput = {
    ...
    user?: XOR<UserRelationFilter, UserWhereInput>
    userId?: StringFilter | string
    submissionItem?: XOR<EventSubmissionItemRelationFilter, EventSubmissionItemWhereInput>
  ...
  export type TumiEventCreateInput = {
    ...
    organizerLimit: number
    publicationState?: PublicationState
    participantSignup?: TumiEventCreateparticipantSignupInput | Enumerable<MembershipStatus>
    organizerSignup?: TumiEventCreateorganizerSignupInput | Enumerable<MembershipStatus>
  ...
  export type TumiEventUpdateInput = {
    ...
    publicationState?: EnumPublicationStateFieldUpdateOperationsInput | PublicationState
    participantSignup?: TumiEventUpdateparticipantSignupInput | Enumerable<MembershipStatus>
    organizerSignup?: TumiEventUpdateorganizerSignupInput | Enumerable<MembershipStatus>
  ...
  export type TumiEventCreateManyInput = {
    ...
    creatorId: string
    eventTemplateId: string
    participantSignup?: TumiEventCreateManyparticipantSignupInput | Enumerable<MembershipStatus>
    organizerSignup?: TumiEventCreateManyorganizerSignupInput | Enumerable<MembershipStatus>
  }
  ...
  export type EventSubmissionItemUpdateInput = {
    ...
    submissionTime?: EnumSubmissionTimeFieldUpdateOperationsInput | SubmissionTime
  ...
  export type UsersOfTenantsCreateNestedManyWithoutTenantInput = {
    create?: XOR<Enumerable<UsersOfTenantsCreateWithoutTenantInput>, Enumerable<UsersOfTenantsUncheckedCreateWithoutTenantInput>>
  ...
  export type EventTemplateCreateNestedManyWithoutTenantInput = {
    create?: XOR<Enumerable<EventTemplateCreateWithoutTenantInput>, Enumerable<EventTemplateUncheckedCreateWithoutTenantInput>>
  ...
  export type EventOrganizerCreateNestedManyWithoutTenantInput = {
    create?: XOR<Enumerable<EventOrganizerCreateWithoutTenantInput>, Enumerable<EventOrganizerUncheckedCreateWithoutTenantInput>>
  ...
  export type UsersOfTenantsCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<UsersOfTenantsCreateWithoutUserInput>, Enumerable<UsersOfTenantsUncheckedCreateWithoutUserInput>>
  ...
  export type EventSubmissionCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<EventSubmissionCreateWithoutUserInput>, Enumerable<EventSubmissionUncheckedCreateWithoutUserInput>>
  ...
  export type ReceiptCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<ReceiptCreateWithoutUserInput>, Enumerable<ReceiptUncheckedCreateWithoutUserInput>>
  ...
  export type TumiEventCreateNestedManyWithoutCreatedByInput = {
    create?: XOR<Enumerable<TumiEventCreateWithoutCreatedByInput>, Enumerable<TumiEventUncheckedCreateWithoutCreatedByInput>>
  ...
  export type TenantCreateNestedOneWithoutOrganizersInput = {
    create?: XOR<TenantCreateWithoutOrganizersInput, TenantUncheckedCreateWithoutOrganizersInput>
    connectOrCreate?: TenantCreateOrConnectWithoutOrganizersInput
    connect?: TenantWhereUniqueInput
  }

  export type TumiEventCreateNestedManyWithoutOrganizerInput = {
    create?: XOR<Enumerable<TumiEventCreateWithoutOrganizerInput>, Enumerable<TumiEventUncheckedCreateWithoutOrganizerInput>>
  ...
  export type TenantUpdateOneRequiredWithoutOrganizersInput = {
    ...
    connect?: TenantWhereUniqueInput
    update?: XOR<TenantUpdateWithoutOrganizersInput, TenantUncheckedUpdateWithoutOrganizersInput>
  }
  ...
  export type TumiEventCreateNestedManyWithoutEventTemplateInput = {
    create?: XOR<Enumerable<TumiEventCreateWithoutEventTemplateInput>, Enumerable<TumiEventUncheckedCreateWithoutEventTemplateInput>>
  ...
  export type TenantCreateNestedOneWithoutEventTemplatesInput = {
    create?: XOR<TenantCreateWithoutEventTemplatesInput, TenantUncheckedCreateWithoutEventTemplatesInput>
  ...
  export type TenantUpdateOneRequiredWithoutEventTemplatesInput = {
    ...
    connect?: TenantWhereUniqueInput
    update?: XOR<TenantUpdateWithoutEventTemplatesInput, TenantUncheckedUpdateWithoutEventTemplatesInput>
  }
  ...
  export type EventSubmissionItemCreateNestedManyWithoutEventInput = {
    create?: XOR<Enumerable<EventSubmissionItemCreateWithoutEventInput>, Enumerable<EventSubmissionItemUncheckedCreateWithoutEventInput>>
  ...
  export type CostItemCreateNestedManyWithoutEventInput = {
    create?: XOR<Enumerable<CostItemCreateWithoutEventInput>, Enumerable<CostItemUncheckedCreateWithoutEventInput>>
  ...
  export type PhotoShareCreateNestedOneWithoutEventInput = {
    create?: XOR<PhotoShareCreateWithoutEventInput, PhotoShareUncheckedCreateWithoutEventInput>
  ...
  export type EventTemplateCreateNestedOneWithoutEventInstancesInput = {
    create?: XOR<EventTemplateCreateWithoutEventInstancesInput, EventTemplateUncheckedCreateWithoutEventInstancesInput>
  ...
  export type PhotoShareUpdateOneWithoutEventInput = {
    ...
    disconnect?: boolean
    delete?: boolean
    update?: XOR<PhotoShareUpdateWithoutEventInput, PhotoShareUncheckedUpdateWithoutEventInput>
  }
  ...
  export type EventTemplateUpdateOneRequiredWithoutEventInstancesInput = {
    ...
    connect?: EventTemplateWhereUniqueInput
    update?: XOR<EventTemplateUpdateWithoutEventInstancesInput, EventTemplateUncheckedUpdateWithoutEventInstancesInput>
  }
  ...
  export type TumiEventCreateNestedOneWithoutCostItemsInput = {
    create?: XOR<TumiEventCreateWithoutCostItemsInput, TumiEventUncheckedCreateWithoutCostItemsInput>
  ...
  export type ReceiptCreateNestedManyWithoutCostItemInput = {
    create?: XOR<Enumerable<ReceiptCreateWithoutCostItemInput>, Enumerable<ReceiptUncheckedCreateWithoutCostItemInput>>
  ...
  export type TumiEventUpdateOneRequiredWithoutCostItemsInput = {
    ...
    connect?: TumiEventWhereUniqueInput
    update?: XOR<TumiEventUpdateWithoutCostItemsInput, TumiEventUncheckedUpdateWithoutCostItemsInput>
  }
  ...
  export type CostItemCreateNestedOneWithoutReceiptsInput = {
    create?: XOR<CostItemCreateWithoutReceiptsInput, CostItemUncheckedCreateWithoutReceiptsInput>
  ...
  export type CostItemUpdateOneRequiredWithoutReceiptsInput = {
    ...
    connect?: CostItemWhereUniqueInput
    update?: XOR<CostItemUpdateWithoutReceiptsInput, CostItemUncheckedUpdateWithoutReceiptsInput>
  }

  export type TumiEventCreateNestedOneWithoutPhotoShareInput = {
    create?: XOR<TumiEventCreateWithoutPhotoShareInput, TumiEventUncheckedCreateWithoutPhotoShareInput>
  ...
  export type TumiEventUpdateOneRequiredWithoutPhotoShareInput = {
    ...
    connect?: TumiEventWhereUniqueInput
    update?: XOR<TumiEventUpdateWithoutPhotoShareInput, TumiEventUncheckedUpdateWithoutPhotoShareInput>
  }
  ...
  export type TumiEventCreateNestedOneWithoutRegistrationsInput = {
    create?: XOR<TumiEventCreateWithoutRegistrationsInput, TumiEventUncheckedCreateWithoutRegistrationsInput>
  ...
  export type TumiEventUpdateOneRequiredWithoutRegistrationsInput = {
    ...
    connect?: TumiEventWhereUniqueInput
    update?: XOR<TumiEventUpdateWithoutRegistrationsInput, TumiEventUncheckedUpdateWithoutRegistrationsInput>
  }

  export type TumiEventCreateNestedOneWithoutSubmissionItemsInput = {
    create?: XOR<TumiEventCreateWithoutSubmissionItemsInput, TumiEventUncheckedCreateWithoutSubmissionItemsInput>
  ...
  export type EventSubmissionCreateNestedManyWithoutSubmissionItemInput = {
    create?: XOR<Enumerable<EventSubmissionCreateWithoutSubmissionItemInput>, Enumerable<EventSubmissionUncheckedCreateWithoutSubmissionItemInput>>
  ...
  export type TumiEventUpdateOneRequiredWithoutSubmissionItemsInput = {
    ...
    connect?: TumiEventWhereUniqueInput
    update?: XOR<TumiEventUpdateWithoutSubmissionItemsInput, TumiEventUncheckedUpdateWithoutSubmissionItemsInput>
  }
  ...
  export type EventSubmissionItemCreateNestedOneWithoutSubmissionsInput = {
    create?: XOR<EventSubmissionItemCreateWithoutSubmissionsInput, EventSubmissionItemUncheckedCreateWithoutSubmissionsInput>
  ...
  export type EventSubmissionItemUpdateOneRequiredWithoutSubmissionsInput = {
    ...
    connect?: EventSubmissionItemWhereUniqueInput
    update?: XOR<EventSubmissionItemUpdateWithoutSubmissionsInput, EventSubmissionItemUncheckedUpdateWithoutSubmissionsInput>
  }
  ...
  export type UsersOfTenantsCreateOrConnectWithoutTenantInput = {
    where: UsersOfTenantsWhereUniqueInput
    create: XOR<UsersOfTenantsCreateWithoutTenantInput, UsersOfTenantsUncheckedCreateWithoutTenantInput>
  }
  ...
  export type EventTemplateCreateOrConnectWithoutTenantInput = {
    where: EventTemplateWhereUniqueInput
    create: XOR<EventTemplateCreateWithoutTenantInput, EventTemplateUncheckedCreateWithoutTenantInput>
  }
  ...
  export type EventOrganizerCreateOrConnectWithoutTenantInput = {
    where: EventOrganizerWhereUniqueInput
    create: XOR<EventOrganizerCreateWithoutTenantInput, EventOrganizerUncheckedCreateWithoutTenantInput>
  }
  ...
  export type UsersOfTenantsUpsertWithWhereUniqueWithoutTenantInput = {
    where: UsersOfTenantsWhereUniqueInput
    update: XOR<UsersOfTenantsUpdateWithoutTenantInput, UsersOfTenantsUncheckedUpdateWithoutTenantInput>
    create: XOR<UsersOfTenantsCreateWithoutTenantInput, UsersOfTenantsUncheckedCreateWithoutTenantInput>
  }

  export type UsersOfTenantsUpdateWithWhereUniqueWithoutTenantInput = {
    where: UsersOfTenantsWhereUniqueInput
    data: XOR<UsersOfTenantsUpdateWithoutTenantInput, UsersOfTenantsUncheckedUpdateWithoutTenantInput>
  }

  export type UsersOfTenantsUpdateManyWithWhereWithoutTenantInput = {
    where: UsersOfTenantsScalarWhereInput
    data: XOR<UsersOfTenantsUpdateManyMutationInput, UsersOfTenantsUncheckedUpdateManyWithoutUsersInput>
  }
  ...
  export type EventTemplateUpsertWithWhereUniqueWithoutTenantInput = {
    where: EventTemplateWhereUniqueInput
    update: XOR<EventTemplateUpdateWithoutTenantInput, EventTemplateUncheckedUpdateWithoutTenantInput>
    create: XOR<EventTemplateCreateWithoutTenantInput, EventTemplateUncheckedCreateWithoutTenantInput>
  }

  export type EventTemplateUpdateWithWhereUniqueWithoutTenantInput = {
    where: EventTemplateWhereUniqueInput
    data: XOR<EventTemplateUpdateWithoutTenantInput, EventTemplateUncheckedUpdateWithoutTenantInput>
  }

  export type EventTemplateUpdateManyWithWhereWithoutTenantInput = {
    where: EventTemplateScalarWhereInput
    data: XOR<EventTemplateUpdateManyMutationInput, EventTemplateUncheckedUpdateManyWithoutEventTemplatesInput>
  }
  ...
  export type EventOrganizerUpsertWithWhereUniqueWithoutTenantInput = {
    where: EventOrganizerWhereUniqueInput
    update: XOR<EventOrganizerUpdateWithoutTenantInput, EventOrganizerUncheckedUpdateWithoutTenantInput>
    create: XOR<EventOrganizerCreateWithoutTenantInput, EventOrganizerUncheckedCreateWithoutTenantInput>
  }

  export type EventOrganizerUpdateWithWhereUniqueWithoutTenantInput = {
    where: EventOrganizerWhereUniqueInput
    data: XOR<EventOrganizerUpdateWithoutTenantInput, EventOrganizerUncheckedUpdateWithoutTenantInput>
  }

  export type EventOrganizerUpdateManyWithWhereWithoutTenantInput = {
    where: EventOrganizerScalarWhereInput
    data: XOR<EventOrganizerUpdateManyMutationInput, EventOrganizerUncheckedUpdateManyWithoutOrganizersInput>
  }
  ...
  export type UsersOfTenantsCreateOrConnectWithoutUserInput = {
    where: UsersOfTenantsWhereUniqueInput
    create: XOR<UsersOfTenantsCreateWithoutUserInput, UsersOfTenantsUncheckedCreateWithoutUserInput>
  }
  ...
  export type TumiEventCreateOrConnectWithoutCreatedByInput = {
    where: TumiEventWhereUniqueInput
    create: XOR<TumiEventCreateWithoutCreatedByInput, TumiEventUncheckedCreateWithoutCreatedByInput>
  }
  ...
  export type UsersOfTenantsUpsertWithWhereUniqueWithoutUserInput = {
    where: UsersOfTenantsWhereUniqueInput
    update: XOR<UsersOfTenantsUpdateWithoutUserInput, UsersOfTenantsUncheckedUpdateWithoutUserInput>
    create: XOR<UsersOfTenantsCreateWithoutUserInput, UsersOfTenantsUncheckedCreateWithoutUserInput>
  }

  export type UsersOfTenantsUpdateWithWhereUniqueWithoutUserInput = {
    where: UsersOfTenantsWhereUniqueInput
    data: XOR<UsersOfTenantsUpdateWithoutUserInput, UsersOfTenantsUncheckedUpdateWithoutUserInput>
  }

  export type UsersOfTenantsUpdateManyWithWhereWithoutUserInput = {
    where: UsersOfTenantsScalarWhereInput
    data: XOR<UsersOfTenantsUpdateManyMutationInput, UsersOfTenantsUncheckedUpdateManyWithoutTenantsInput>
  }
  ...
  export type EventSubmissionUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<EventSubmissionUpdateManyMutationInput, EventSubmissionUncheckedUpdateManyWithoutEventSubmissionsInput>
  }
  ...
  export type TumiEventUpsertWithWhereUniqueWithoutCreatedByInput = {
    where: TumiEventWhereUniqueInput
    update: XOR<TumiEventUpdateWithoutCreatedByInput, TumiEventUncheckedUpdateWithoutCreatedByInput>
    create: XOR<TumiEventCreateWithoutCreatedByInput, TumiEventUncheckedCreateWithoutCreatedByInput>
  }

  export type TumiEventUpdateWithWhereUniqueWithoutCreatedByInput = {
    where: TumiEventWhereUniqueInput
    data: XOR<TumiEventUpdateWithoutCreatedByInput, TumiEventUncheckedUpdateWithoutCreatedByInput>
  }

  export type TumiEventUpdateManyWithWhereWithoutCreatedByInput = {
    where: TumiEventScalarWhereInput
    data: XOR<TumiEventUpdateManyMutationInput, TumiEventUncheckedUpdateManyWithoutCreatedEventsInput>
  }
  ...
  export type TumiEventCreateOrConnectWithoutOrganizerInput = {
    where: TumiEventWhereUniqueInput
    create: XOR<TumiEventCreateWithoutOrganizerInput, TumiEventUncheckedCreateWithoutOrganizerInput>
  }
  ...
  export type TumiEventUpsertWithWhereUniqueWithoutOrganizerInput = {
    where: TumiEventWhereUniqueInput
    update: XOR<TumiEventUpdateWithoutOrganizerInput, TumiEventUncheckedUpdateWithoutOrganizerInput>
    create: XOR<TumiEventCreateWithoutOrganizerInput, TumiEventUncheckedCreateWithoutOrganizerInput>
  }

  export type TumiEventUpdateWithWhereUniqueWithoutOrganizerInput = {
    where: TumiEventWhereUniqueInput
    data: XOR<TumiEventUpdateWithoutOrganizerInput, TumiEventUncheckedUpdateWithoutOrganizerInput>
  }

  export type TumiEventUpdateManyWithWhereWithoutOrganizerInput = {
    where: TumiEventScalarWhereInput
    data: XOR<TumiEventUpdateManyMutationInput, TumiEventUncheckedUpdateManyWithoutEventsInput>
  }
  ...
  export type TumiEventCreateOrConnectWithoutEventTemplateInput = {
    where: TumiEventWhereUniqueInput
    create: XOR<TumiEventCreateWithoutEventTemplateInput, TumiEventUncheckedCreateWithoutEventTemplateInput>
  }
  ...
  export type TumiEventUpsertWithWhereUniqueWithoutEventTemplateInput = {
    where: TumiEventWhereUniqueInput
    update: XOR<TumiEventUpdateWithoutEventTemplateInput, TumiEventUncheckedUpdateWithoutEventTemplateInput>
    create: XOR<TumiEventCreateWithoutEventTemplateInput, TumiEventUncheckedCreateWithoutEventTemplateInput>
  }

  export type TumiEventUpdateWithWhereUniqueWithoutEventTemplateInput = {
    where: TumiEventWhereUniqueInput
    data: XOR<TumiEventUpdateWithoutEventTemplateInput, TumiEventUncheckedUpdateWithoutEventTemplateInput>
  }

  export type TumiEventUpdateManyWithWhereWithoutEventTemplateInput = {
    where: TumiEventScalarWhereInput
    data: XOR<TumiEventUpdateManyMutationInput, TumiEventUncheckedUpdateManyWithoutEventInstancesInput>
  }
  ...
  export type EventSubmissionItemCreateOrConnectWithoutEventInput = {
    where: EventSubmissionItemWhereUniqueInput
    create: XOR<EventSubmissionItemCreateWithoutEventInput, EventSubmissionItemUncheckedCreateWithoutEventInput>
  }
  ...
  export type CostItemCreateOrConnectWithoutEventInput = {
    where: CostItemWhereUniqueInput
    create: XOR<CostItemCreateWithoutEventInput, CostItemUncheckedCreateWithoutEventInput>
  }
  ...
  export type EventSubmissionItemUpsertWithWhereUniqueWithoutEventInput = {
    where: EventSubmissionItemWhereUniqueInput
    update: XOR<EventSubmissionItemUpdateWithoutEventInput, EventSubmissionItemUncheckedUpdateWithoutEventInput>
    create: XOR<EventSubmissionItemCreateWithoutEventInput, EventSubmissionItemUncheckedCreateWithoutEventInput>
  }

  export type EventSubmissionItemUpdateWithWhereUniqueWithoutEventInput = {
    where: EventSubmissionItemWhereUniqueInput
    data: XOR<EventSubmissionItemUpdateWithoutEventInput, EventSubmissionItemUncheckedUpdateWithoutEventInput>
  }

  export type EventSubmissionItemUpdateManyWithWhereWithoutEventInput = {
    where: EventSubmissionItemScalarWhereInput
    data: XOR<EventSubmissionItemUpdateManyMutationInput, EventSubmissionItemUncheckedUpdateManyWithoutSubmissionItemsInput>
  }
  ...
  export type CostItemUpsertWithWhereUniqueWithoutEventInput = {
    where: CostItemWhereUniqueInput
    update: XOR<CostItemUpdateWithoutEventInput, CostItemUncheckedUpdateWithoutEventInput>
    create: XOR<CostItemCreateWithoutEventInput, CostItemUncheckedCreateWithoutEventInput>
  }

  export type CostItemUpdateWithWhereUniqueWithoutEventInput = {
    where: CostItemWhereUniqueInput
    data: XOR<CostItemUpdateWithoutEventInput, CostItemUncheckedUpdateWithoutEventInput>
  }

  export type CostItemUpdateManyWithWhereWithoutEventInput = {
    where: CostItemScalarWhereInput
    data: XOR<CostItemUpdateManyMutationInput, CostItemUncheckedUpdateManyWithoutCostItemsInput>
  }
  ...
  export type ReceiptCreateOrConnectWithoutCostItemInput = {
    where: ReceiptWhereUniqueInput
    create: XOR<ReceiptCreateWithoutCostItemInput, ReceiptUncheckedCreateWithoutCostItemInput>
  }
  ...
  export type ReceiptUpsertWithWhereUniqueWithoutCostItemInput = {
    where: ReceiptWhereUniqueInput
    update: XOR<ReceiptUpdateWithoutCostItemInput, ReceiptUncheckedUpdateWithoutCostItemInput>
    create: XOR<ReceiptCreateWithoutCostItemInput, ReceiptUncheckedCreateWithoutCostItemInput>
  }

  export type ReceiptUpdateWithWhereUniqueWithoutCostItemInput = {
    where: ReceiptWhereUniqueInput
    data: XOR<ReceiptUpdateWithoutCostItemInput, ReceiptUncheckedUpdateWithoutCostItemInput>
  }
  ...
  export type EventSubmissionCreateOrConnectWithoutSubmissionItemInput = {
    where: EventSubmissionWhereUniqueInput
    create: XOR<EventSubmissionCreateWithoutSubmissionItemInput, EventSubmissionUncheckedCreateWithoutSubmissionItemInput>
  }
  ...
  export type EventSubmissionUpsertWithWhereUniqueWithoutSubmissionItemInput = {
    where: EventSubmissionWhereUniqueInput
    update: XOR<EventSubmissionUpdateWithoutSubmissionItemInput, EventSubmissionUncheckedUpdateWithoutSubmissionItemInput>
    create: XOR<EventSubmissionCreateWithoutSubmissionItemInput, EventSubmissionUncheckedCreateWithoutSubmissionItemInput>
  }

  export type EventSubmissionUpdateWithWhereUniqueWithoutSubmissionItemInput = {
    where: EventSubmissionWhereUniqueInput
    data: XOR<EventSubmissionUpdateWithoutSubmissionItemInput, EventSubmissionUncheckedUpdateWithoutSubmissionItemInput>
  }

  export type EventSubmissionUpdateManyWithWhereWithoutSubmissionItemInput = {
    where: EventSubmissionScalarWhereInput
    data: XOR<EventSubmissionUpdateManyMutationInput, EventSubmissionUncheckedUpdateManyWithoutSubmissionsInput>
  }
